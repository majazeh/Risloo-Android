...
public class FragmentAuthPin extends Fragment {
    ...
    private void startCountDownTimer() {
        ...
        binding.timerViewFlipper.resendTextView.setText(SpannableManager.spanClickable(requireActivity().getResources().getString(R.string.PinFragmentResend), 24, 34, clickableSpan));

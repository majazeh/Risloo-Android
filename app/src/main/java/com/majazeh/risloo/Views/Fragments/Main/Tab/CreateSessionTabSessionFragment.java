...
public class CreateSessionTabSessionFragment extends Fragment {
    ...
    private void initializer() {
        ...
        InitManager.txtTextColorBackground(binding.createTextView.getRoot(), getResources().getString(R.string.CreateSessionTabSessionButton), getResources().getColor(R.color.White), R.drawable.draw_16sdp_solid_blue500_ripple_blue800);
    }

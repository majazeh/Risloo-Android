...
public class IntroActivity extends AppCompatActivity {
    ...
    private void initializer() {
        ...
        introRtlViewPager = findViewById(R.id.activity_intro_rtlViewPager);
    ...
    private void addDots(int currentPage) {
        ...
        for (int i = 0; i < dotsTextView.length; i++) {
            ...
            dotsTextView[i].setTextSize(getResources().getDimension(R.dimen._12ssp));
    ...
    private boolean getIntro() {
        ...
        return singleton.getIntro();
    }

    private void navigator() {
        IntentManager.main(this);
        singleton.setIntro(false);
    }

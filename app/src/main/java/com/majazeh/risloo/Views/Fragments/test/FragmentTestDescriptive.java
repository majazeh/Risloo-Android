...
public class FragmentTestDescriptive extends Fragment {
    ...
    private void listener() {
        ...
        binding.answerEditText.inputEditText.setOnEditorActionListener((v, actionId, event) -> {
            ...
            ((ActivityTest) requireActivity()).inputon.clear();
            return false;
        });
    ...
    private void setEditTextCount(int count) {
        ...
        binding.answerEditText.countTextView.setText(SpannableManager.spanForegroundColorSize(value, 0, endIndex, getResources().getColor(R.color.coolGray700), (int) getResources().getDimension(R.dimen._11ssp)));
    }

...
public class FragmentRoom extends Fragment {
    ...
    private void initializer() {
        ...
        InitManager.rcvHorizontalFixed(requireActivity(), binding.tagsRecyclerView, 0, 0, getResources().getDimension(R.dimen._2sdp), 0);
        InitManager.rcvVerticalFixedUnnested(requireActivity(), binding.casesSingleLayout.recyclerView, getResources().getDimension(R.dimen._12sdp), 0, getResources().getDimension(R.dimen._4sdp), getResources().getDimension(R.dimen._12sdp));
    }
    ...
    private void listener() {
                ...
                case "اعضاء":
                    if (!type.equals("room")) {
                        if (centerModel != null)
                            ...
                            ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentCenterUsers(roomModel.getCenter());

                    } else {
                        ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentRoomUsers(roomModel);
                    } break;
                case "برنامه درمانی":
                    if (!type.equals("room")) {
                        if (centerModel != null)
                            ...
                            ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentCenterSchedules(roomModel.getCenter());

                    } else {
                        ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentRoomSchedules(roomModel);
                    } break;
                case "تعریف برنامه درمانی":
                    ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentCreateSchedule(roomModel);
                    break;
                case "پروفایل من":
                    if (!type.equals("room")) {
                        if (centerModel != null)
                            ...
                            ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentReference(roomModel.getCenter(), ((ActivityMain) requireActivity()).singleton.getUserModel());

                    } else {
                        ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentReference(roomModel, ((ActivityMain) requireActivity()).singleton.getUserModel());
                    } break;
                case "ویرایش":
                    if (!type.equals("room")) {
                        if (centerModel != null)
                            ...
                            ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentEditCenter(roomModel.getCenter());

                    } else {
                        ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentEditCenter(roomModel);
                    } break;
                case "محل برگزاری جلسات":
                    if (!type.equals("room")) {
                        if (centerModel != null)
                            ...
                            ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentCenterPlatforms(roomModel.getCenter());

                    } else {
                        ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentRoomPlatforms(roomModel);
                    } break;
                case "برچسب\u200Cهای مهم":
                    if (!type.equals("room")) {
                        if (centerModel != null)
                            ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentCenterTags(centerModel);
                        else
                            ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentCenterTags(roomModel.getCenter());

                    } else {
                        ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentRoomTags(roomModel);
                    } break;
                case "حسابداری": {
                    if (!type.equals("room")) {
                        if (centerModel != null)
                            ...
                            ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentCenterAccounting(roomModel.getCenter());
        ...
        CustomClickView.onClickListener(() -> {
            if (roomModel != null)
                ((ActivityMain) requireActivity()).navigatoon.navigateToFragmentCreateCase(roomModel);
...
//            items.add(requireActivity().getResources().getString(R.string.RoomFragmentAccounting));
        ...
        if (items.size() > 2) {
            ...
            switch (items.get(0)) {
                case "اعضاء":
                    InitManager.spOvalSingle(requireActivity(), binding.menuSpinner.selectSpinner, binding.menuSpinner.selectImageView, R.drawable.ic_users_light, R.color.coolGray500, R.drawable.draw_oval_solid_white_border_1sdp_coolgray300_ripple_coolgray300, items.get(0));
                    break;
                case "برنامه درمانی":
                    InitManager.spOvalSingle(requireActivity(), binding.menuSpinner.selectSpinner, binding.menuSpinner.selectImageView, R.drawable.ic_calendar_alt_light, R.color.coolGray500, R.drawable.draw_oval_solid_white_border_1sdp_coolgray300_ripple_coolgray300, items.get(0));
                    break;
                case "تعریف برنامه درمانی":
                    InitManager.spOvalSingle(requireActivity(), binding.menuSpinner.selectSpinner, binding.menuSpinner.selectImageView, R.drawable.ic_calendar_plus_light, R.color.coolGray500, R.drawable.draw_oval_solid_white_border_1sdp_coolgray300_ripple_coolgray300, items.get(0));
                    break;
                case "پروفایل من":
                    InitManager.spOvalSingle(requireActivity(), binding.menuSpinner.selectSpinner, binding.menuSpinner.selectImageView, R.drawable.ic_user_light, R.color.coolGray500, R.drawable.draw_oval_solid_white_border_1sdp_coolgray300_ripple_coolgray300, items.get(0));
                    break;
                case "ویرایش":
                    ...
                    break;
                case "محل برگزاری جلسات":
                    InitManager.spOvalSingle(requireActivity(), binding.menuSpinner.selectSpinner, binding.menuSpinner.selectImageView, R.drawable.ic_map_marker_alt_light, R.color.coolGray500, R.drawable.draw_oval_solid_white_border_1sdp_coolgray300_ripple_coolgray300, items.get(0));
                    break;
                case "برچسب\u200Cهای مهم":
                    InitManager.spOvalSingle(requireActivity(), binding.menuSpinner.selectSpinner, binding.menuSpinner.selectImageView, R.drawable.ic_tags_light, R.color.coolGray500, R.drawable.draw_oval_solid_white_border_1sdp_coolgray300_ripple_coolgray300, items.get(0));
                    break;
                case "حسابداری":
                    InitManager.spOvalSingle(requireActivity(), binding.menuSpinner.selectSpinner, binding.menuSpinner.selectImageView, R.drawable.ic_calculator_light, R.color.coolGray500, R.drawable.draw_oval_solid_white_border_1sdp_coolgray300_ripple_coolgray300, items.get(0));
                    break;
            }
        } else {
            ...
            public void onOK(Object object) {
                ...
                if (isAdded()) {
                    requireActivity().runOnUiThread(() -> {
                        ...
                        SnackManager.showSnackSucces(requireActivity(), getResources().getString(R.string.SnackSuccesAcceptation));

    ...
    public void checkRequire() {
        ...
        if (time instanceof CreateSessionTabTimeFragment) {
            ...
            if (((CreateSessionTabTimeFragment) time).binding.durationErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), ((CreateSessionTabTimeFragment) time).binding.durationIncludeLayout.inputEditText, ((CreateSessionTabTimeFragment) time).binding.durationErrorLayout.getRoot(), ((CreateSessionTabTimeFragment) time).binding.durationErrorLayout.errorTextView);
            if (((CreateSessionTabTimeFragment) time).binding.dateTypeErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), (ConstraintLayout) null, ((CreateSessionTabTimeFragment) time).binding.dateTypeErrorLayout.getRoot(), ((CreateSessionTabTimeFragment) time).binding.dateTypeErrorLayout.errorTextView);
            if (((CreateSessionTabTimeFragment) time).binding.specifiedDateErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), ((CreateSessionTabTimeFragment) time).binding.specifiedDateIncludeLayout.selectTextView, ((CreateSessionTabTimeFragment) time).binding.specifiedDateErrorLayout.getRoot(), ((CreateSessionTabTimeFragment) time).binding.specifiedDateErrorLayout.errorTextView);
            if (((CreateSessionTabTimeFragment) time).binding.patternDaysErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), ((CreateSessionTabTimeFragment) time).binding.patternDaysIncludeLayout.selectRecyclerView, ((CreateSessionTabTimeFragment) time).binding.patternDaysErrorLayout.getRoot(), ((CreateSessionTabTimeFragment) time).binding.patternDaysErrorLayout.errorTextView);
            if (((CreateSessionTabTimeFragment) time).binding.patternTypeErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), (ConstraintLayout) null, ((CreateSessionTabTimeFragment) time).binding.patternTypeErrorLayout.getRoot(), ((CreateSessionTabTimeFragment) time).binding.patternTypeErrorLayout.errorTextView);
            if (((CreateSessionTabTimeFragment) time).binding.repeatWeeksErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), ((CreateSessionTabTimeFragment) time).binding.repeatWeeksIncludeLayout.inputEditText, ((CreateSessionTabTimeFragment) time).binding.repeatWeeksErrorLayout.getRoot(), ((CreateSessionTabTimeFragment) time).binding.repeatWeeksErrorLayout.errorTextView);
            if (((CreateSessionTabTimeFragment) time).binding.periodStartDateErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), ((CreateSessionTabTimeFragment) time).binding.periodStartDateIncludeLayout.selectTextView, ((CreateSessionTabTimeFragment) time).binding.periodStartDateErrorLayout.getRoot(), ((CreateSessionTabTimeFragment) time).binding.periodStartDateErrorLayout.errorTextView);
            if (((CreateSessionTabTimeFragment) time).binding.periodEndDateErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), ((CreateSessionTabTimeFragment) time).binding.periodEndDateIncludeLayout.selectTextView, ((CreateSessionTabTimeFragment) time).binding.periodEndDateErrorLayout.getRoot(), ((CreateSessionTabTimeFragment) time).binding.periodEndDateErrorLayout.errorTextView);
        }
        ...
        if (platform instanceof CreateSessionTabPlatformFragment) {
            if (((CreateSessionTabPlatformFragment) platform).binding.platformsErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), (ConstraintLayout) null, ((CreateSessionTabPlatformFragment) platform).binding.platformsErrorLayout.getRoot(), ((CreateSessionTabPlatformFragment) platform).binding.platformsErrorLayout.errorTextView);
            if (((CreateSessionTabPlatformFragment) platform).binding.pinPlatformErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), (ConstraintLayout) null, ((CreateSessionTabPlatformFragment) platform).binding.pinPlatformErrorLayout.getRoot(), ((CreateSessionTabPlatformFragment) platform).binding.pinPlatformErrorLayout.errorTextView);
            if (((CreateSessionTabPlatformFragment) platform).binding.identifierPlatformErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), (ConstraintLayout) null, ((CreateSessionTabPlatformFragment) platform).binding.identifierPlatformErrorLayout.getRoot(), ((CreateSessionTabPlatformFragment) platform).binding.identifierPlatformErrorLayout.errorTextView);
        }
        ...
        if (payment instanceof CreateSessionTabPaymentFragment) {
            if (((CreateSessionTabPaymentFragment) payment).binding.paymentErrorLayout.getRoot().getVisibility() == View.VISIBLE)
                ((MainActivity) requireActivity()).controlEditText.check(requireActivity(), ((CreateSessionTabPaymentFragment) payment).binding.paymentIncludeLayout.selectSpinner, ((CreateSessionTabPaymentFragment) payment).binding.paymentErrorLayout.getRoot(), ((CreateSessionTabPaymentFragment) payment).binding.paymentErrorLayout.errorTextView);
        }

...
public class FragmentCenterAccounting extends Fragment {
    ...
    private void initializer() {
        ...
        InitManager.lytTextColorResTintBackground(requireActivity(), binding.commissionsIncludeLayout.getRoot(), binding.commissionsIncludeLayout.selectTextView, binding.commissionsIncludeLayout.selectImageView, getResources().getString(R.string.CenterAccountingFragmentCommissions), getResources().getColor(R.color.coolGray500), R.drawable.ic_abacus_light, R.color.red400, R.drawable.draw_2sdp_solid_white_border_1sdp_coolgray200_ripple_red200);
        InitManager.lytTextColorResTintBackground(requireActivity(), binding.balancesIncludeLayout.getRoot(), binding.balancesIncludeLayout.selectTextView, binding.balancesIncludeLayout.selectImageView, getResources().getString(R.string.CenterAccountingFragmentBalances), getResources().getColor(R.color.coolGray500), R.drawable.ic_balance_scale_light, R.color.coolGray500, R.drawable.draw_2sdp_solid_white_border_1sdp_coolgray200_ripple_coolgray200);
        InitManager.lytTextColorResTintBackground(requireActivity(), binding.discountsIncludeLayout.getRoot(), binding.discountsIncludeLayout.selectTextView, binding.discountsIncludeLayout.selectImageView, getResources().getString(R.string.CenterAccountingFragmentDiscount), getResources().getColor(R.color.coolGray500), R.drawable.ic_badge_percent_light, R.color.pink500, R.drawable.draw_2sdp_solid_white_border_1sdp_coolgray200_ripple_pink200);
    }

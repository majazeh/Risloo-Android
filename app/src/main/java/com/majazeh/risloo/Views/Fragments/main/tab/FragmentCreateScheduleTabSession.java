...
public class FragmentCreateScheduleTabSession extends Fragment {

    // Binding
    private FragmentCreateScheduleTabSessionBinding binding;
    ...
    private void initializer() {
        ...
        InitManager.rvVerticalUnfixed(requireActivity(), binding.axisIncludeLayout.selectRecyclerView, 0, 0, getResources().getDimension(R.dimen._2sdp), 0);

        InitManager.txtTextColorBackground(binding.createTextView.getRoot(), getResources().getString(R.string.CreateScheduleTabSessionButton), getResources().getColor(R.color.white), R.drawable.draw_24sdp_solid_risloo500_ripple_risloo700);
    }
    ...
    public void showValid(String key, String validation) {
        switch (key) {
            ...
            case "closed_at":
                ...
                break;
            case "fields":
                ((ActivityMain) requireActivity()).validatoon.showValid(binding.axisErrorLayout.getRoot(), binding.axisErrorLayout.errorTextView, validation);
                break;
            case "description":

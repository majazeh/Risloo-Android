...
public class EditUserFragment extends Fragment {
    ...
    private void initializer() {
        ...
        tabLayoutMediator = new TabLayoutMediator(binding.tabLayout.getRoot(), binding.viewPager.getRoot(), (tab, i) -> {
            ...
            Objects.requireNonNull(tab.getIcon()).setColorFilter(ContextCompat.getColor(requireActivity(), R.color.Gray400), PorterDuff.Mode.SRC_IN);
        });
    }
    ...
    private void listener() {
        binding.tabLayout.getRoot().addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                Objects.requireNonNull(tab.getIcon()).setColorFilter(ContextCompat.getColor(requireActivity(), R.color.Blue600), PorterDuff.Mode.SRC_IN);
            }

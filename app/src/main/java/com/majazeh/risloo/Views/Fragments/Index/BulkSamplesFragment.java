...
public class BulkSamplesFragment extends Fragment {
    ...
    // Adapters
    private BulkSamplesAdapter adapter;
    ...
    private void initializer() {
        adapter = new BulkSamplesAdapter(requireActivity());
                    ...
                    requireActivity().runOnUiThread(() -> {
                        ...
                        if (!items.data().isEmpty()) {
                            ...
                            if (binding.searchIncludeLayout.progressBar.getVisibility() == View.VISIBLE)
                                ...
                                binding.indexSingleLayout.emptyView.getRoot().setText(getResources().getString(R.string.BulkSamplesFragmentEmpty));
                        }

...
import com.majazeh.risloo.databinding.DialogMultiBinding;

import java.util.Objects;

public class MultiDialog extends AppCompatDialogFragment {

    // Binding
    private DialogMultiBinding binding;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        DialogMultiBinding binding = DialogMultiBinding.inflate(LayoutInflater.from(requireActivity()));
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle savedInstanceState) {
        binding = DialogMultiBinding.inflate(inflater, viewGroup, false);

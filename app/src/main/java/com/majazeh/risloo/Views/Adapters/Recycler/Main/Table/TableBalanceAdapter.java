...
//            BalanceModel model = (BalanceModel) items.get(i - 1);
    ...
    private void setWidget(HeaderBalanceHolder holder) {
        holder.binding.amountTextView.setText(SpannableManager.spanForegroundColorSize(activity.getResources().getString(R.string.BalanceAdapterAmount), 10, 17, activity.getResources().getColor(R.color.coolGray500), (int) activity.getResources().getDimension(R.dimen._7ssp)));
    }

...
public class FragmentCreateRoomUser extends Fragment {
            ...
            public void onOK(Object object) {
                if (isAdded()) {
                    requireActivity().runOnUiThread(() -> {
                        ...
                        SnackManager.showSnackSucces(requireActivity(), getResources().getString(R.string.SnackCreatedNewRoomUser));

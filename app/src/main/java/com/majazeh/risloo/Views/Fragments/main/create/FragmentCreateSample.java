...
public class FragmentCreateSample extends Fragment {
    ...
    private void initializer() {
        ...
        DropdownManager.spinner12ssp(requireActivity(), binding.caseStatusIncludeLayout.selectSpinner, R.array.CaseStatus);
    ...
    private void setArgs() {
        ...
        binding.scaleGuideLayout.guideTextView.setText(SpannableManager.spanClickable(requireActivity().getResources().getString(R.string.CreateSampleFragmentScaleGuide), 220, 228, assessmentLinkSpan));
    }

...
public class PermissionManager {
    ...
    */
    ...
    public static boolean permissionDocument(Activity activity) {
    ...
    public static boolean permissionDownload(Activity activity) {
        String[] permissions = {Manifest.permission.WRITE_EXTERNAL_STORAGE};
        int requestCode = 300;
    ...
    public static boolean permissionGallery(Activity activity) {
        String[] permissions = {Manifest.permission.READ_EXTERNAL_STORAGE};
        int requestCode = 400;
